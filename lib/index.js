...
module.exports = function router (options) {
  ...
  var endpoints = [
    ...
    { action: 'all', path: '/crossdomain.xml', route: routes.crossdomain }
  ]
  ...
  if (options && options.redis) {
    router.use('/conditional', routes.conditionals(options.redis))
  } else {
    debug('no redis dsn provided, will not load conditional routes')
  }
